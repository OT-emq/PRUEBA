            ...
            <table class="w-full">
                ...
                <thead class="bg-blue-500 text-white">
                    ...
                    <tr>
                        ...
                        <th class="p-4 border w-60">Acciones</th>
                ...
                <tbody>
                    ...
                    <tr class="text-center hover:bg-gray-100">
                        ...
                        <td class="border p-3">Juan</td>
                        <td class="border p-3">Pérez</td>

                        <td class="border p-3">

                            <div class="flex justify-center gap-2">

                                <a href="{{ route('trabajadores.edit',1) }}"
                    ...
                    <tr class="text-center hover:bg-gray-100">
                        ...
                        <td class="border p-3">Mon</td>
                        <td class="border p-3">Laferte
